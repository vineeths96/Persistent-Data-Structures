...
{
  int_stack_pp* newlist = (int_stack_pp*) malloc(sizeof(int_stack_pp));
...
int_Node* int_update_parentLeft_list_pp(int_stack_pp* list, int_Node* lCrawl, int_Node* newnode, int live_version)
{
...
int_Node* int_update_parentRight_list_pp(int_stack_pp* list, int_Node* lCrawl, int_Node* newnode, int live_version)
{
...
bool int_insert_list_pp(int_stack_pp* list, int data, int index)
{
  if(index<0)
    {
...
int int_delete_list_pp(int_stack_pp* list, int index)
{
  if(index<0)
    {
      printf("Index cannot be negative");

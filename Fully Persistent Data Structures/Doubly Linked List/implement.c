...
{
  int_list_fp* newlist = (int_list_fp*) malloc(sizeof(int_list_fp));
...
int_Node* int_update_parentLeft_list_fp(int_list_fp* list, int_Node* lCrawl, int_Node* newnode, int live_version, int version)
{
...
int_Node* int_update_parentRight_list_fp(int_list_fp* list, int_Node* lCrawl, int_Node* newnode, int live_version, int version)
{
  if(lCrawl == NULL) return NULL;
  ...
  if(index != index_count) 
    {
      ...
      int_insert_list_fp(list, data, index, version);
      return true;
    }
  else
    {     
